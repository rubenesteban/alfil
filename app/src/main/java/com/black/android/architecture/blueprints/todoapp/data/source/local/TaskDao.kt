...
interface TaskDao {
    ...
    @Query("SELECT * FROM task WHERE category ='A'")
    fun observeAllA(): Flow<List<LocalTask>>

    @Query("SELECT * FROM task WHERE category ='B'")
    fun observeAllB(): Flow<List<LocalTask>>

    @Query("SELECT * FROM task WHERE category ='C'")
    fun observeAllC(): Flow<List<LocalTask>>
