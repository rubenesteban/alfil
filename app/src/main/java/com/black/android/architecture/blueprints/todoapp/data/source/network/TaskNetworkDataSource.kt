...
package com.black.android.architecture.blueprints.todoapp.data.source.network
...
class TaskNetworkDataSource @Inject constructor() : NetworkDataSource {
    ...
    private var tasks = listOf(
        NetworkTask(
            ...
            category = "Build tower in Pisa",
            price = "Build tower in Pisa",
            uprice = "Build tower in Pisa",
            quanty = "Build tower in Pisa",
