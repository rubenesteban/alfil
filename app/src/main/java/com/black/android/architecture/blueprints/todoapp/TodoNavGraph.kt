...
import com.example.android.architecture.blueprints.todoapp.tasks.StateScreen
import com.example.android.architecture.blueprints.todoapp.tasks.TasksScreen
import com.example.android.architecture.blueprints.todoapp.tasks.aScreen
...
fun TodoNavGraph(
    ...
    NavHost(
        ...
        composable(
            ...
            AppModalDrawer(drawerState, currentRoute, navActions) {
                TasksScreen(
                    ...
                    openpluma1 = { navActions.navigateTo1() },
                    openpluma2 = { navActions.navigateTo2() },
                    openpluma3 = { navActions.navigateToSta() }
                )
            }
        }
        ...
        composable(TodoDestinations.state_ROUTE) {
            AppModalDrawer(drawerState, currentRoute, navActions) {
                StateScreen(
                    openDrawer = { coroutineScope.launch { drawerState.open() } },
                    openpluma1 = { navActions.navigateTo1() },
