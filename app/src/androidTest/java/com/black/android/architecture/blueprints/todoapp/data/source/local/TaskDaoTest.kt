...
package com.black.android.architecture.blueprints.todoapp.data.source.local
...
class TaskDaoTest {
    ...
    // process is killed
    private lateinit var database: com.black.android.architecture.blueprints.todoapp.data.source.local.ToDoDatabase
    ...
    fun initDb() {
        database = Room.inMemoryDatabaseBuilder(
            ...
            com.black.android.architecture.blueprints.todoapp.data.source.local.ToDoDatabase::class.java
        ).allowMainThreadQueries().build()
    }
    @Test
    fun insertTaskAndGetById() = runTest {
        // GIVEN - insert a task
        val task = com.black.android.architecture.blueprints.todoapp.data.source.local.LocalTask(
            title = "title",
        ...
        assertNotNull(loaded as com.black.android.architecture.blueprints.todoapp.data.source.local.LocalTask)
    ...
    fun insertTaskReplacesOnConflict() = runTest {
        ...
        val newTask = com.black.android.architecture.blueprints.todoapp.data.source.local.LocalTask(
            title = "title2",
    ...
    fun updateTaskAndGetById() = runTest {
        ...
        val originalTask =
            com.black.android.architecture.blueprints.todoapp.data.source.local.LocalTask(
                title = "title",
                description = "description",
                id = "id",
                isCompleted = false,
