...
package com.black.android.architecture.blueprints.todoapp.addedittask
...
class AddEditTaskScreenTest {
    ...
    fun setup() {
        ...
        composeTestRule.setContent {
            AppCompatTheme {
                Surface {
                    com.black.android.architecture.blueprints.todoapp.addedittask.AddEditTaskScreen(
                        viewModel = com.black.android.architecture.blueprints.todoapp.addedittask.AddEditTaskViewModel(
                            repository,
                            SavedStateHandle()
                        ),
